...
<body>
    ...
    <nav id="nav" class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#">
            <img src="http://v2.aftermathlab.com/wp-content/uploads/2019/06/logo-horizontal-transparent.png" height="54"
                width="170" id="logo">
        </a>
        ...
        <div class="collapse navbar-collapse res-dropdown" id="navbarNavAltMarkup">
            <div class="navbar-nav">

                <a class="nav-item nav-links navbar-text" href="https://aftermathlab.com/shop/">SHOP</a>
                <a class="nav-item nav-links navbar-text" href="https://aftermathlab.com/about/">ABOUT</a>
                <a class="nav-item nav-links navbar-text" href="https://aftermathlab.com/blog/">BLOG</a>
                <a class="nav-item nav-links navbar-text" id="cart-icon" href="http://v2.aftermathlab.com/cart-2/">
